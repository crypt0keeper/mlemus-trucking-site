    ...
    <div className="relative container-max px-4 sm:px-6 lg:px-8 pt-24">
      <div className="max-w-3xl">
        ...
        <div className="inline-flex items-center gap-2 bg-primary/15 border border-primary/30 rounded-full px-4 py-1.5 mb-6 animate-fade-in-up">
          ...
          <span className="text-xs font-medium uppercase tracking-wider text-primary">TWIC Certified · Port Access Ready</span>
        </div>

        <h1 className="font-heading text-4xl sm:text-5xl lg:text-7xl font-bold text-primary-foreground uppercase leading-[1.1] mb-6 animate-fade-in-up" style={{ animationDelay: "0.1s" }}>
